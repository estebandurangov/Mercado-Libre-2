...
const Nav = () => {
  ...
  return (
    <nav className='bg-nav'>
        <div className='hidden text-sm xl:text-base lg:flex justify-between h-[100px] px-10 2xl:px-2 w-full 2xl:w-2/3 m-auto py-2'>
            ...
            <div className='w-2/8 flex flex-col justify-end'>
